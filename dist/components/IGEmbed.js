...
const IGEmbed = ({ url, backgroundUrl, igVersion = defaultIgVersion, linkText = defaultLinkText, processDelay = 100, scriptImportDisabled = false, linkTextDisabled = false, backgroundBlurDisabled = false, softFilterDisabled = false, ...blockQuoteProps }) => {
    ...
    return (React.createElement(React.Fragment, null,
        !scriptImportDisabled && !embedScriptLoaded && (embedScriptLoaded = true) && (React.createElement(react_helmet_1.Helmet, null, React.createElement("script", { src: "//www.instagram.com/embed.js" }))),

...
const IGEmbed = ({ url, backgroundUrl, igVersion, viewPostText, ...blockQuoteProps }) => {
    React.useEffect(() => {
        ...
        React.createElement("blockquote", { className: (0, classnames_1.default)('instagram-media', blockQuoteProps.className), "data-instgrm-permalink": `${cleanUrlWithEndingSlash}?utm_source=ig_embed&utm_campaign=loading`, "data-instgrm-version": igVersionToUse, ...blockQuoteProps, style: {
            ...
            React.createElement("div", { style: { padding: '16px' } },
                React.createElement("a", { href: `${cleanUrlWithEndingSlash}?utm_source=ig_embed&utm_campaign=loading`, style: {
                    ...
                    React.createElement(IGBody, { url: cleanUrlWithEndingSlash, backgroundUrl: backgroundUrl, viewPostText: viewPostTextToUse }),
                    React.createElement(IGFooter, null))))));
};
exports.IGEmbed = IGEmbed;
const IGHeader = () => {
    return (React.createElement("div", { style: { display: 'flex', flexDirection: 'row', alignItems: 'center' } },
    ...
    return (React.createElement("div", { style: {
        ...
        React.createElement("div", { style: {
            ...
            React.createElement("div", { style: { display: 'block', height: '50px', margin: '0 auto 12px', width: '50px' } },
                React.createElement("svg", { width: "50px", height: "50px", viewBox: "0 0 60 60", version: "1.1", xmlns: "https://www.w3.org/2000/svg", xmlnsXlink: "https://www.w3.org/1999/xlink" },
            ...
            !!props.viewPostText && (React.createElement(React.Fragment, null,
